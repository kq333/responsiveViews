    ...
    <nav class="menu">
      ...
      <nav  class="menuMobile">
           <ul class="menuNav">
             ...
             <li  class="menuNav__hamburger">
                <div class="menuNav__hamburger__bar__top"></div>
                  <div class="menuNav__hamburger__bar__middle"></div>
                  <div class="menuNav__hamburger__bar__bottom"></div>
