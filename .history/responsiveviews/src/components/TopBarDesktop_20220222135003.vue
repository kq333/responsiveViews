    ...
    <nav class="menu">
      <ul class="menu__routes">
        <li class="menu__routes__product"  >
          <router-link :class="[changeLinkColor ?'menu__routes__product product--whiteColor' : 'menu__routes__product product--blackColor']" to="/">Product name</router-link>
        </li>
...
export default {
  ...
  setup() {
    ...
    return { store, pageName, changeColor };
  },
};
</script>
