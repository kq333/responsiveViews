<template>
  <div class="containers">
    <div class="icon" :class=" {'icon--colorBorder' : colorProductName }" >
      <div class="icon__circle" :class="{ 'icon__circle--colorBorder ' : colorProductName }"></div>
      <div class="icon__ellipse"  :class="{ 'icon__ellipse--colorBorder ' : colorProductName }"></div>
    </div>
  </div>
</template>
