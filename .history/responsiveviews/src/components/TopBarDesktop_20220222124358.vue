    ...
    <nav class="menu">
      <ul class="menu__routes">
        <li class="menu__routes__product"  >
          <router-link :class="[changeLinkColor ? '' : 'product--blackColor']" to="/">Product name</router-link>
        </li>
...
export default {
  ...
  setup() {
    ...
    return { store, pageName, router,currentPathObject,  changeColor, changeLinkColor };
  },
};
</script>
