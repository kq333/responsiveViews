    ...
    <nav class="menuMobile">
      <div class="menuNav" >
        ...
        <div class="menuNav__hamburger">
          <div class="hamburger-menu" @click="active = !active"  :class="{ 'menu__routes__product--whiteColor': colorProductName }">
      ...
      <ol v-if="active" class="menuList"  :class="{ 'menu__routes__product--whiteColor': colorProductName }">
        <ul class="menuList__items" >
          <li class="menuList__items__links"  :class="{ 'menu__routes__product--whiteColor': colorProductName }">
            <router-link to="/about">About</router-link>
          </li>
