    ...
    <nav class="menu">
      <ul class="menu__routes">
        <li class="menu__routes__product"  >
          <router-link :class="[changeLinkColor ?'menu__routes__product product--blackColor' :  `menu__routes__${clickedPage}product--whiteColor`]" to="/">Product name</router-link>
        </li>
...
export default {
  ...
  setup() {
    ...
    function changeLinkColor(){
         ...
         if (pageName.value === "Collection") {
            clickedPage.value = 'product'
              return clickedPage.value
    ...
    return { store, pageName, changeColor, changeLinkColor, clickedPage };
  },
};
</script>
