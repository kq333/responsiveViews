    ...
    <nav class="menu">
      ...
      <nav  class="menuMobile">
           <ol class="menuNav">
             ...
             <ul class="menuNav__hamburger">
                <li class="menuNav__hamburger__bar__top"></li>
                  <li class="menuNav__hamburger__bar__middle"></li>
                  <li class="menuNav__hamburger__bar__bottom"></li>
