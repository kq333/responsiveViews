      ...
      <nav  class="menuMobile">
           <div class="menuNav">
            ...
            >Product name
             ...
             <div  class="menuNav__hamburger" @click="active =!active">
...
export default {
  ...
  setup() {
    ...
    return { store, pageName, changeColor, changeColorLink, colorProductName, active };
  },
};
</script>
