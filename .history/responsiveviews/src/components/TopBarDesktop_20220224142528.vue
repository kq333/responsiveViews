    ...
    <nav class="menuMobile">
      <div class="menuNav" >
        <div class="menuNav__product" >
          <router-link
            to="/"   :class="{ 'menu__routes__product--whiteColor': colorProductName }"
            >Product name
          </router-link>
        </div>
      ...
      <ol v-if="active" class="menuList" :class="[changeColor ? `container--${pageName}` : 'container']" >
        <ul class="menuList__items" >
          <li class="menuList__items__links" >
            <router-link to="/about">About</router-link>
          </li>
          <li class="menuList__items__links" :class="[changeColor ? `container--${pageName}` : 'container']">
            <router-link
              to="/collection"
              >Collection</router-link
            >
